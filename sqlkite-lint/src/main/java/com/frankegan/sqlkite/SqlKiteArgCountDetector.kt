...
private const val KITE_DATABASE = "com.frankegan.sqlkite.KiteDatabase"
private const val QUERY_METHOD_NAME = "query"
private const val CREATE_QUERY_METHOD_NAME = "createQuery"

class SqlKiteArgCountDetector : Detector(), Detector.UastScanner {
  ...
  companion object {
    ...
    val ISSUE: Issue = Issue.create(
        ...
        9,
        Severity.ERROR,
        Implementation(SqlKiteArgCountDetector::class.java, EnumSet.of(JAVA_FILE, TEST_SOURCES)))
  }
  ...
  override fun getApplicableMethodNames() = listOf(CREATE_QUERY_METHOD_NAME, QUERY_METHOD_NAME)
    ...
    if (evaluator.isMemberInClass(method, KITE_DATABASE)) {
